...
import { magicGenerate } from "@/modules/bookmark/actions/ai.actions";
import { createBookmark, updateBookmark } from "@/modules/bookmark/actions/bookmark.actions";
      ...
      <form action={formAction} className="flex flex-col h-full">
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-6">
          ...
          {state?.message && !state.success && (
            <div className="text-sm p-3 rounded-lg bg-red-500/10 text-red-400">{state.message}</div>
          )}
        </div>
