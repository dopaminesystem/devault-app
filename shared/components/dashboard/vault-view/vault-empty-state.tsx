...
export function VaultEmptyState({ search, setSearch, canEdit, onOpenNew }: VaultEmptyStateProps) {
  return (
    <div className="col-span-full flex flex-col items-center justify-center py-20 px-4">
      {search ? (
        ...
        // biome-ignore lint/a11y/useKeyWithClickEvents: whole area is clickable
        // biome-ignore lint/a11y/noStaticElementInteractions: whole area is clickable
        <div
          onClick={() => canEdit && onOpenNew()}
          className={`group relative w-full max-w-md flex flex-col items-center justify-center p-12 border-2 border-dashed border-zinc-800 rounded-3xl bg-zinc-900/10 transition-all duration-300 text-center space-y-4 ${
            canEdit
              ? "hover:bg-zinc-900/30 hover:border-zinc-700 cursor-pointer"
