            ...
            <div className="space-y-4">
                ...
                >
                    ...
                    >
                        ...
                        <div className="space-y-1">
                            <span className="font-medium text-zinc-200 cursor-pointer">Discord Server Member</span>
                            <p className="text-xs text-zinc-500">Only members of a specific Discord server can view.</p>
                        </div>
                    </label>
                </RadioGroup>
            </div>
