    ...
    <Dialog>
      <DialogTrigger asChild>
        <div className="flex flex-col items-center justify-center p-6 rounded-xl border border-dashed border-zinc-800 bg-zinc-900/20 hover:bg-zinc-900/40 transition-colors gap-4 cursor-pointer group h-full min-h-[200px]">
          ...
          <p className="text-sm text-zinc-500 font-medium group-hover:text-zinc-300">
            Create New Vault
          </p>
        </div>
      </DialogTrigger>
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>Create a new vault to organize your bookmarks.</DialogDescription>
        </DialogHeader>
