        ...
        <form action={action} className="space-y-6">
            ...
            <div className="space-y-4">
                <div className="space-y-2">
                    <Label htmlFor="name" className="text-base font-medium text-zinc-200">Vault Name</Label>
                    <Input
                        id="name"
                        name="name"
                ...
                <div className="space-y-2">
                    <Label htmlFor="description" className="text-base font-medium text-zinc-200">Description</Label>
                    <Textarea
                        id="description"
                        name="description"
            ...
            {state?.message && (
                <p className={`text-sm p-3 rounded-lg ${state.message.includes("success") ? "bg-emerald-500/10 text-emerald-400" : "bg-red-500/10 text-red-400"}`}>
                    {state.message}
                </p>
            )}

            <div className="flex justify-start pt-2">
                <Button type="submit" disabled={isPending} className="bg-zinc-100 text-zinc-950 hover:bg-white">
