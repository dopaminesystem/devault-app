...
export const TOKENS = {
    canvas: "bg-ds-canvas text-ds-text-primary antialiased selection:bg-[--ds-selection] font-sans min-h-screen",
    ...
    sidebarActive: "bg-ds-brand-subtle text-ds-brand-text hover:bg-ds-brand-subtle hover:text-[--ds-brand-text-dim]",
    sidebarInactive: "text-ds-text-secondary hover:text-ds-text-primary border border-transparent hover:bg-ds-surface-raised",
}
