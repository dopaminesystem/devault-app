...
export const DISCORD_ERROR_MESSAGES: Record<DiscordErrorReason, ReasonMessage> = {
  no_discord_account: {
    ...
    description:
      "This vault requires Discord server membership. Please connect your Discord account to continue.",
    buttonText: "Connect Discord",
  },
  token_expired: {
    title: "Reconnect Discord",
    description:
      "Your Discord connection needs to be refreshed. This usually happens when permissions have been updated.",
  ...
  no_role: {
    ...
    description:
      "You are in the Discord server, but you don't have the required role to access this vault.",
